export default class gameState extends Phaser.State {
    ...
    createAnims() {
        ...
        //jump
        this.jumpRight = this.hero.animations.add('jump-right', Phaser.Animation.generateFrameNames('jump-right-', 0, 5, '-1.3', 2), 15, false, false);
        this.jumpLeft = this.hero.animations.add('jump-left', Phaser.Animation.generateFrameNames('jump-left-', 0, 5, '-1.3', 2), 15, false, false);
		
		//static jump
		this.upRight = this.hero.animations.add('up-right', Phaser.Animation.generateFrameNames('crnr-jmp-right-', 0, 1, '-1.3', 2), 10, false, false);
		this.upLeft = this.hero.animations.add('up-left', Phaser.Animation.generateFrameNames('crnr-jmp-left-', 0, 1, '-1.3', 2), 10, false, false);
		...
		this.upRight.onStart.add(function() { this.hero.isJumping = true; }, this);
        this.upLeft.onStart.add(function() { this.hero.isJumping = true; }, this);
    
        this.upRight.onComplete.add(function() { this.hero.animations.play('idle-right'); this.hero.isJumping = false; }, this);
        this.upLeft.onComplete.add(function() { this.hero.animations.play('idle-left'); this.hero.isJumping = false; }, this);
